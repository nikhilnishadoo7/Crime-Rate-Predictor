...
def predict_result():
    if model is None:
        return "Model could not be loaded. Please check for errors."
    ...
    # Using compound growth formula instead of fixed 1% growth
    year_diff = year - 2011
    ...
    return render_template('result.html', city_name=city_name, crime_type=crime_type,
                           year=year, crime_status=crime_status, crime_rate=crime_rate,
